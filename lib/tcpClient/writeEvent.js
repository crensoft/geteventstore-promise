...
export default (config) => async (streamName, eventId, eventType, data, metaData, options) => {
	...
	const event = client.createJsonEventData(eventId || uuid.v4(), data, metaData, eventType);
